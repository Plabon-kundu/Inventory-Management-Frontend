...
return ( <div className="dashboard-wrapper"> <div className="glow-circle top-right"></div> <div className="glow-circle bottom-left"></div>
  ...
  <aside className="glass-sidebar">
    ...
    <nav>
      <Link
        to="/movement-logs"
        className={`nav-item ${
          location.pathname === "/movement-logs" ? "active" : ""
        }`}
      >
        Inventory-Movement
      </Link>
          ...
          <tbody>
            {warehouses.map((wh) => (
              <tr key={wh.id}>
                ...
                <td>
                  <span className="pill">{wh.location}</span>
                </td>
